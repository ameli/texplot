...
# Options for theme
html_theme_options = {
    "github_url": "https://github.com/ameli/texplot",
    "navbar_end": [
        "theme-switcher",
        "search-field.html",
    ...
    "icon_links": [
        {
            "name": "PyPI",
            "url": "https://pypi.org/project/texplot/",
            "icon": "fab fa-python",
            "type": "fontawesome",
        },
        {
            "name": "Anaconda Cloud",
            "url": "https://anaconda.org/s-ameli/texplot",
            "icon": "fa fa-circle-notch",
            "type": "fontawesome",
        },
        {
            "name": "Online texplot Platform",
            "url": "https://texplot.org",
    ...
    "logo": {
        "image_light": "images/icons/logo-texplot-light.png",
        "image_dark": "images/icons/logo-texplot-dark.png",
    },
}
...
# html_logo = '_static/images/icons/logo-texplot-light.png'
html_favicon = '_static/images/icons/favicon.ico'

# Open Graph cards for sharing the documentation on social media
ogp_site_url = 'https://ameli.github.io/texplot'
ogp_image = 'https://texplot.org/public/images/card.png'
ogp_site_name = 'texplot'
